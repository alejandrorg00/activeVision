...
<p align="center">
  <img src="data/renders/airplane_demo/motion_sequence/out/saliency_window_action.gif" width="650">
</p>
...
4. **Compute proto-object attention**

   Events are accumulated over short temporal windows. Each event frame is processed with a multiscale centre-surround saliency operator. The resulting saliency map is converted into a probability distribution using a temperature-weighted softmax:
